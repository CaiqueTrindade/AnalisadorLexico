            ...
            if (ascii != 13) {
                ...
                switch (estado_atual) {
                    case "inicio":
                        ...
                        // Condição para iniciar a maquina de estados para operador relacional de atribuição
                        } else if (ascii == 61) {
                            lexema = lexema + caractere;
                            estado_atual = "igual";
                        // Condição para iniciar a maquina de estados para operador lógico de negação
                        // caracter !
                        } else if (ascii == 33) {
                            lexema = lexema + caractere;
                            estado_atual = "negacao";
                        // Condição para iniciar a maquina de estados para operador lógico
                        // caracter &
                        } else if (ascii == 38) {
                            lexema = lexema + caractere;
                            estado_atual = "eComercial";
                        // Condição para iniciar a maquina de estados para operador relacional
                        // caracteres > e <
